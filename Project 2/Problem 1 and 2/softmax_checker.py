...
def verifyInputOutputTypesSoftmax():
    ...
    cost = computeCostFunction(trainX, trainY, theta, lambdaFactor, tempParameter)
    ...
    theta = runGradientDescentIteration(trainX, trainY, theta, alpha, lambdaFactor, tempParameter)
