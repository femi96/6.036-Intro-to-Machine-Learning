...
from utils import *
import numpy as np
from features import cubicFeatures

def verifyCubicFeatures1D():
    X=np.array([[np.sqrt(3)],[0]])
    X_cube=np.sort(cubicFeatures(X))
...
verifyCubicFeatures1D()
verifyCubicFeatures2D()
verifyCubicFeatures2D2()
